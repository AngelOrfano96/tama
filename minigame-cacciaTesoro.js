...
function startTreasureLevel() {
  ...
  const tile = window.treasureTile;            // esiste già
treasurePet.posPX = treasurePet.x * tile;    // posizione in PIXEL sul canvas
treasurePet.posPY = treasurePet.y * tile;
treasurePet.size  = tile - 12;               // come prima (padding che usavi nel draw)
treasurePet.speedPX = tile * 4;              // velocità in pixel/sec (placeholder per dopo)
...
const px = treasurePet.posPX;  // ora usiamo le posizioni in pixel
const py = treasurePet.posPY;
