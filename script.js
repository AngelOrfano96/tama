// script.js (ottimizzato per persistenza immediata e degradazione offline)
...
async function initFlow() {
  ...
  if (!stateErr && state) {
    ...
    // Persisti nuovo stato degradato
    await saveState();
    startGame();
  } else {
