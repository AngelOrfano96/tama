// script.js (versione corretta con await e funzioni valide)
...
// Utils per mostrare/nascondere elementi
...
// Flusso iniziale dopo autenticazione
async function initFlow() {
  ...
  if (!stateErr && state) {
    ...
    // Salva subito il nuovo stato degradato
    await saveState();
    startGame();
  } else {
